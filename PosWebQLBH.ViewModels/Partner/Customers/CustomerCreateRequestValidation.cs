...
{
    public class CustomerCreateRequestValidation : AbstractValidator<CustomerCreateRequest> 
    {
        public CustomerCreateRequestValidation()
        {
            //RuleFor(x => x.ID_Customer).NotEmpty().WithMessage("Mã nhà cung cấp là bắt buộc");
            //   .Matches(@"^[a-zA-z0-9]*$")
